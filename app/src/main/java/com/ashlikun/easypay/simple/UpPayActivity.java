...
public class UpPayActivity extends AppCompatActivity implements View.OnClickListener, Handler.Callback, Runnable, OnPayCallback {
    /*****************************************************************
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.obj == null || ((String) msg.obj).length() == 0) {
            ...
            easyPay = EasyPay.startPay(this, PayEntity.get(EasyPay.CHANNEL_ALIPAY).setOrderInfo((String) msg.obj).setUpDebug(true), this);
        }
        return false;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        easyPay.onUpActivityResult(data);
    }
}
